...
import { FileText, Target, Lightbulb, Lock, ChevronLeft, ChevronRight } from 'lucide-react';
...
export default function CluesPanel({ isOpen, onToggle }: CluesPanelProps) {
  const clues: Clue[] = [
    { id: '1', title: '피 묻은 메모', description: '3-7-2-9... 숫자의 의미는?', time: '5분 전' },
    { id: '2', title: '오래된 열쇠', description: '녹슨 열쇠, 어디에 사용할까?', time: '12분 전' },
  ];

  const objectives = [
    { id: '1', text: '약장의 비밀번호 찾기', completed: false },
    { id: '2', text: '앵무새와 대화하기', completed: true },
    { id: '3', text: '3층 출구 찾기', completed: false },
  ];
    ...
    <div className="h-full relative flex">
      ...
      <div className="p-4 border-b border-cyan-400/20">
        ...
        <div className="space-y-2">
          {objectives.map((objective) => (
            ...
            >
              <div className={`w-4 h-4 rounded-sm border-2 mt-0.5 flex items-center justify-center ${
                objective.completed
      ...
      <div className="p-4 border-t border-cyan-400/20">
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-cyan-400 text-xs font-semibold">33%</span>
        </div>
